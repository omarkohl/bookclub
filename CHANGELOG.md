...
- Votes on a deleted book were not removed, causing participants to appear over-budget and unable to vote

## [0.3.0] - 2026-04-22

### Fixed

- Clicking the description text in a book card now expands/collapses it again (regression from 0.2.0)
- Alignment of nomination status in admin participant stats view
- Warning now shown in admin view when credits are not fully distributed
...
[0.4.0]: https://github.com/omarkohl/bookclub/compare/v0.3.0...v0.4.0
[0.3.0]: https://github.com/omarkohl/bookclub/compare/v0.2.0...v0.3.0
